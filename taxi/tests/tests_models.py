...
class CarModelTest(TestCase):
    ...
    def test_car_drivers_relation(self):
        driver = Driver.objects.create(username="John", license_number="DL123")
        manufacturer = Manufacturer.objects.create(
            name="BMW",
            country="Germany"
        )
...
class DriverModelTest(TestCase):
    ...
    def test_license_number_unique(self):
        Driver.objects.create(username="driver1", license_number="DL001")
        with self.assertRaises(Exception):
            Driver.objects.create(username="driver2", license_number="DL001")
